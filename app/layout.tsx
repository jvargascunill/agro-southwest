  ...
  const jsonLd = {
    ...
    "@graph": [
      ...
      },
      {
        ...
        description: "Exportación de cítricos frescos desde Chile: limones, naranjas y mandarinas. Calibres 75 a 200, Global G.A.P., Systems Approach. Temporada mayo a diciembre. Trazabilidad y documentación fitosanitaria.",
      ...
      },
      {
        ...
        description: "Exportación de limones frescos desde Chile. Limones premium con certificación Global G.A.P. y Systems Approach. Calibres 75 a 200, temporada mayo a diciembre. Comprar limones para Argentina, Uruguay y más.",
        brand: { "@type": "Brand", name: SEO_SITE_NAME },
        category: "Limones",
